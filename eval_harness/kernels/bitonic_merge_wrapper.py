...
def bitonic_merge_wrapper(x,
    ...
    """Bitonic merge sort for GPU top-k operations.

    Merges a 2-dim tensor along the last dimension and returns argsort tensor.

    :param x: The input tensor to be sorted.
    :param x_indices: The indices tensor to be sorted alongside x.
    :param a_shape_1: The second dimension size (must be 4).
    """
