...
@register_sketch("key_rerotation")
@dataclass
class KeyRerotationSketch(BaseSketch):
    """
    Key Rerotation: RoPE-aware compression wrapper for maintaining positional encoding.

    Enhances any ScorerSketch by applying key rerotation after compression to maintain
    ...
    def __post_init__(self):
        assert isinstance(self.press, ScorerSketch)
        logger.warning(
