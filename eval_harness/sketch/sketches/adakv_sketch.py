...
@register_sketch("adakv")
@dataclass
class AdaKVSketch(BaseSketch):
    """
    ...
    applied at ``eval_harness.sketch`` import over ``ALL_ATTENTION_FUNCTIONS``)
    ...
    def __post_init__(self):
        assert isinstance(self.press, ScorerSketch), "AdaKVSketch requires a ScorerSketch as input"
