...
@register_kv_compressor("chunkkv")
@dataclass
class ChunkKVSketch(KVCompressor):
    """
    ChunkKV: Semantic-preserving compression with chunk-wise token selection.

    Enhances any ScorerKVCompressor by applying chunk-wise token selection instead of
    ...
    Parameters
    ----------
    press : ScorerKVCompressor, optional
    ...
    def __post_init__(self):
        ...
        assert isinstance(self.press, ScorerKVCompressor), "ChunkKVSketch requires a ScorerKVCompressor as input"
